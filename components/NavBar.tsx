...
function NavBar() {
  return (
    <nav className="bg-white fixed w-full h-14 flex justify-between items-center pt-8 pb-8">
      <div className="border border-solid border-black m-10">Saer Logo</div>
      <div className="space-x-5">
        <ButtonCustom title="Home" path="/" />
        <ButtonCustom title="Projects" path="/projects" />
        <ButtonCustom title="About" path="/about" />
      </div>
      <div>

...
function NavBar() {
  ...
  return (
    <nav className="top-0 bg-white fixed w-full h-14 flex justify-between items-center p-8 z-10">
      ...
      <div className="flex items-center ml-auto">
        <Link href="/contact">
          <button className="flex items-center justify-center w-10 h-10 rounded-full bg-black text-white hover:opacity-75 m-10 hidden lg:flex">
